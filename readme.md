...
6. **Lancez le serveur Symfony** :
  ...
  symfony serve
  ```
  Votre API backend sera accessible à l’adresse http://127.0.0.1:8000.
...
3. **Configurez l’API Backend** :
  Dans le fichier .env du frontend, assurez-vous que l’URL du backend est correctement définie. Par exemple :
  ```
...
1. Symfony a été choisi pour sa robustesse et ses fonctionnalités intégrées, comme la gestion de la sécurité, des bases de données et des API.
